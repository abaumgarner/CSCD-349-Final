...
public class GameSession
{
   ...
   private void generateParty()
   {
      ...
      while(count != 3)
      {
         ...
         if(classList.compareTo("Warrior") == 0)
         {
            ...
            System.out.println("\n~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
            System.out.println("\n " + partyMember.getName() + " the " + partyMember.getProfession() + " joins the party.\n");
            System.out.println("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n");
            count++;
         }//end if
         ...
         //System.out.println("\n" + partyMember.getName() + " the " + partyMember.getProfession() + " joined the party.\n");
         //count++;
      }//end while
   }//end generateParty
   ...
   private String getCharacterClass(String heroName)
   {
      ...
      while(!regexCheck("[1-" + classes.length +"]", str) || str.length() == 0)
      {		
         if(!regexCheck("[1-" + classes.length +"]", str) || str.length() == 0)
         {
   ...
   private void printSplash()
   {
      ...
      System.out.println(" |   \\ _  _ _ _  __ _ ___ ___ _ _    / __|_ _ __ ___ __ _| |___ _ _ "); 
      System.out.println(" | |) | || | ' \\/ _` / -_) _ \\ ' \\  | (__| '_/ _` \\ V  V / / -_) '_|");
      System.out.println(" |___/ \\_,_|_||_\\__, \\___\\___/_||_|  \\___|_| \\__,_|\\_/\\_/|_\\___|_|");
   ...
   public void intro()
   {
      System.out.println("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
      System.out.println("\nYOUR JOURNEY BEGINS:\n");
      System.out.println("The room is engulfed in darkness. Thick cobwebs fill the corners of the room,");
      System.out.println("and wisps of webbing hang from the ceiling and waver in a wind you can barely");
      System.out.println("feel. One corner of the ceiling has a particularly large clot of webbing within");
      System.out.println("which a goblin's bones are tangled. There are four large wooden doors that");
   ...
   public void synopsis()
   {
      ...
      System.out.println("its darkest corners seeking treasures beyond measure. Collect keys to unlock");
      System.out.println("doors, items to aid your party, and battle monsters as you make your escape."); 
      System.out.println("Few have entered and survived, will you live long enough to tell the tale?\n");
      System.out.println("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
   }//end synopsis
   ...
   public void titleScreen()
   {
      ...
      System.out.println(  "*     Aaron Baumgarner, Ryan Medenwaldt, Josh Ohm                         *");
      System.out.println(  "*                                                                         *");
      System.out.println(  "***************************************************************************");
      System.out.println();
   }//end titleScreen
