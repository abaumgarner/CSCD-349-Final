...
public class LevelUpTester {
	...
	public static String printStats(GameCharacter character) {
		...
		temp = "[" + character.getName() + "] Level: "
				+ character.stats.getLevel() + " Experience: "
				+ character.stats.getExp() + "\n" + "HP: "
				+ character.stats.getMaxHP() + " Strength: "
				+ character.stats.getStr() + " Dexterity: "
				+ character.stats.getDex() + "\n" + "Wisdom: "
				+ character.stats.getWis() + " Vitality: "
				+ character.stats.getVit();
